...
**Note:** The bash script above takes too long to render. It produces the same result as the output of the bash script below:
...
**Note:** To reproduce the result, change the path-name to locate `middle.sh` in your directory.
