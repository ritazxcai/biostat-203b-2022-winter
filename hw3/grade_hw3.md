...
- Q2 (35/40) Shiny app
    ...
    Got a package error load "could not find ggplot". instead of loading dplyr in, simply load in tidyverse everytime which includes everything. `-5`.
...
Each violation takes 2 points off, until all 20 points are depleted. Make sure to check coding style for shiny app (app.R) as well.
    ...
    Bad spacing line 103 and 119 in hw3.rmd file `-4` 
