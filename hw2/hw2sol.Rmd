...
ggplot(data = mimic_icu_cohort) + 
  geom_bar(mapping = aes(x = thirty_day_mort, fill = ethnicity), position = "dodge")
```

`thirty_day_mort` vs. `language`:
```{r}
ggplot(data = mimic_icu_cohort) + 
  geom_bar(mapping = aes(x = thirty_day_mort, fill = language), position = "dodge")
```

`thirty_day_mort` vs. `insurance`:
```{r}
ggplot(data = mimic_icu_cohort) + 
  geom_bar(mapping = aes(x = thirty_day_mort, fill = insurance), position = "dodge")
```

`thirty_day_mort` vs. `marital_status`:
```{r}
ggplot(data = mimic_icu_cohort) + 
  geom_bar(mapping = aes(x = thirty_day_mort, fill = marital_status), position = "dodge")
```

`thirty_day_mort` vs. `gender`:
```{r}
ggplot(data = mimic_icu_cohort) + 
  geom_bar(mapping = aes(x = thirty_day_mort, fill = gender), position = "dodge")
```

`thirty_day_mort` vs. `anchor_year_group`:
```{r}
ggplot(data = mimic_icu_cohort) + 
  geom_bar(mapping = aes(x = thirty_day_mort, fill = anchor_year_group), position = "dodge")
```
...
ggplot(data = mimic_icu_cohort, mapping = aes(x = thirty_day_mort, y = bicarbonate)) + 
  geom_boxplot() +
  coord_flip()
```
...
ggplot(data = mimic_icu_cohort, mapping = aes(x = thirty_day_mort, y = calcium)) + 
  geom_boxplot() +
  coord_flip()
```
...
ggplot(data = mimic_icu_cohort, mapping = aes(x = thirty_day_mort, y = chloride)) + 
  geom_boxplot() +
  coord_flip()
```
...
ggplot(data = mimic_icu_cohort, mapping = aes(x = thirty_day_mort, y = creatinine)) + 
  geom_boxplot() +
  coord_flip()
```
...
ggplot(data = mimic_icu_cohort, mapping = aes(x = thirty_day_mort, y = glucose)) + 
  geom_boxplot() +
  coord_flip()
```
...
ggplot(data = mimic_icu_cohort, mapping = aes(x = thirty_day_mort, y = magnesium)) + 
  geom_boxplot() +
  coord_flip()
```
...
ggplot(data = mimic_icu_cohort, mapping = aes(x = thirty_day_mort, y = potassium)) + 
  geom_boxplot() +
  coord_flip()
```
...
ggplot(data = mimic_icu_cohort, mapping = aes(x = thirty_day_mort, y = sodium)) + 
  geom_boxplot() +
  coord_flip()
```
...
ggplot(data = mimic_icu_cohort, mapping = aes(x = thirty_day_mort, y = hematocrit)) + 
  geom_boxplot() +
  coord_flip()
```
